...
const config: Config = {
  ...
  theme: {
    extend: {
      // Colors/fonts retinted to match real-estate-multi-ai-agent-saas — same
      // scale keys (50-950), only the hex values changed, so no component
      // needs to change which class it uses (bg-brand-600 etc. still works).
      fontFamily: {
