...
export function WidgetManager({
  ...
  const [widgetClampKey, setWidgetClampKey] = useState({ selectedWidgetId, widgets })
  if (widgetClampKey.selectedWidgetId !== selectedWidgetId || widgetClampKey.widgets !== widgets) {
    setWidgetClampKey({ selectedWidgetId, widgets })
    if (widgets.length === 0) {
